    ...
    <div className="py-10 px-4">
      ...
      <div className="mt-10 flex justify-around">
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="mt-2 font-medium text-gray-900 text-sm">
            구매내역
          </span>
        </div>
        <div className="flex flex-col items-center">
          <div className="w-14 h-14 bg-orange-500 rounded-full flex justify-center items-center text-white">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
      ...
      <div className="mt-10">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h4 className="font-bold text-sm text-gray-800">니꼬</h4>
